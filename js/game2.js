...
Game2.prototype = {
    ...
    addButtons: function () {
        game.add.button(20, 50, 'btn_home',
            () => {
                this.stopSounds(); 
                this.click.play(); 
        ...
        this.mute = game.add.button(20, 150, 'btn_mute', this.soundIt, this, 1, 0);
        this.mute.visible = false;
        this.sound = game.add.button(20, 150, 'btn_sound', this.muteIt, this, 1, 0);
    },
    ...
    createBoard: function () {
        this.board = game.add.sprite(Math.floor(Math.random() * (50 - 1 + 1) + 0), 500, 'board');
    ...
    createBlinder: function () {
        ...
        this.blinder.scale.setTo(1.5, 1.9);
